...
function App() {
  return (
    <div className="App">
      <div
        className="flex justify-center items-center h-screen w-screen bg-[#f9f9f9]"
        style={{
      ...
      >
        <div
          ...
          border-gray-200 w-[25rem] h-[15rem] flex flex-col bg-[#f9f9f9]"
        >
          <div className="mx-auto bg-white shadow-sm h-20 w-full flex flex-col justify-center align-middle">
            {/* <div className="mx-auto bg-white w-90 rounded-2xl shadow-sm text-center font-medium text-xl px-2 py-4"> */}
            <h1 className="text-black align-middle   font-semibold text-[20pt] text-black">
              <span className="text-"></span> NEAR MEGAFAST Faucet
            </h1>
            {/* </div> */}
          </div>
          ...
          <div className="mx-auto  px-5 flex-grow  flex flex-col justify-center text-gray-900">
            <div className="text-lg">
              <p className="pb-2">
                To learn about NEAR, here's some for free you can use!
              </p>
              {/* <br className="m-0"/> */}
            </div>
          </div>
